...
<input type="button" class="btn btn-default btn-lg" value="续费1个月" onclick="tovip1()">
<input type="button" class="btn btn-default btn-lg" value="续费12个月" onclick="tovip12()">


<form action="${pageContext.request.contextPath}/vip/vipsj" method="post"  enctype="multipart/form-data">
    <tr>
        自定义续费时间：<input type="text" name="vipTime" placeholder="自定义续费时长(月为单位,最多不能超过120个月)">
        <input type="submit" class="btn btn-warning" value="续费">
    </tr>
</form>
</c:if>
</table>
